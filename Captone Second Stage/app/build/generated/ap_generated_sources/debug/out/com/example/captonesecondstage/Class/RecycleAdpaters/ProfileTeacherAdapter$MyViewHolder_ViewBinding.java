...
public class ProfileTeacherAdapter$MyViewHolder_ViewBinding implements Unbinder {
  private ProfileTeacherAdapter.MyViewHolder target;

  @UiThread
  public ProfileTeacherAdapter$MyViewHolder_ViewBinding(ProfileTeacherAdapter.MyViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ProfileTeacherAdapter.MyViewHolder target = this.target;
